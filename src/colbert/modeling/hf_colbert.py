...
base_class_mapping={
    ...
    "VoVanPhuc/sup-SimCSE-VietNamese-phobert-base": RobertaPreTrainedModel,
    "NlpHUST/electra-base-vn": ElectraPreTrainedModel,
    "vinai/phobert-base-v2": RobertaPreTrainedModel,
    "bkai-foundation-models/vietnamese-bi-encoder": RobertaPreTrainedModel
...
model_object_mapping = {
    ...
    "VoVanPhuc/sup-SimCSE-VietNamese-phobert-base": AutoModel,
    "NlpHUST/electra-base-vn": ElectraModel,
    "vinai/phobert-base-v2": AutoModel,
    "bkai-foundation-models/vietnamese-bi-encoder": AutoModel,
